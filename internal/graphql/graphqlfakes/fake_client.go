...
type FakeClient struct {
	QueryStub        func(context.Context, string, map[string]interface{}, string) ([]byte, error)
...
func (fake *FakeClient) Query(arg1 context.Context, arg2 string, arg3 map[string]interface{}, arg4 string) ([]byte, error) {
...
func (fake *FakeClient) QueryCalls(stub func(context.Context, string, map[string]interface{}, string) ([]byte, error)) {
	fake.queryMutex.Lock()
	defer fake.queryMutex.Unlock()
	fake.QueryStub = stub
}

func (fake *FakeClient) QueryArgsForCall(i int) (context.Context, string, map[string]interface{}, string) {
	fake.queryMutex.RLock()
	defer fake.queryMutex.RUnlock()
